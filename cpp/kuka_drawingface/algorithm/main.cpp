...
//                for(int z = 0; z < currentX.size(); z++){
                    curVecX.push_back(currentX.at(0).x);
                    curVecY.push_back(currentX.at(0).y);
                                    curVecX.push_back(currentX.at(currentX.size()-1).x);
                                    curVecY.push_back(currentX.at(currentX.size()-1).y);
//                }
                cout << "begin: "<< endl;
