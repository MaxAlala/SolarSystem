...
void opencv::runNode(int argc, char** argv, Eigen::Vector3d& position_of_the_first_match, Eigen::Quaterniond& r_quat) {
    ...
    while (ros::ok()) {
        ...
        cout << "after sending. \n ";
        r.sleep();
        InteractiveMarkerRos interactiveMarker(position_of_the_first_match, r_quat);
