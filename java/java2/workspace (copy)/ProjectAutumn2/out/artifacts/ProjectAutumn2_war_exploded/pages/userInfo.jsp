...
<div class="book_list2">
    ...
    <%
        ...
        list = bookList.getUnitsById(Integer.parseInt(request.getParameter("user_id")));
        AuthorList authorList = new AuthorList();
        Author author1 = authorList.getAuthorById(Integer.parseInt(request.getParameter("user_id")));
//        request.getSession().setAttribute("nameImage", author1.getName());
    ...
    <div class="user_image">
        ...
        <a href="#"><img src="<%=request.getContextPath()%>/LocalShowPersonImage?name2=<%= author1.getName()%>" <% System.out.println(request.getContextPath() + "/LocalShowPersonImage" + author1.getName());%> height="100" width="100" alt="user"/></a> <br>
        <%= author1.getName() %>
    </div>
