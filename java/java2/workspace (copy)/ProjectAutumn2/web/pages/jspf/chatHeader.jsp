...
<div class="container">
    ...
    <div class="header2">
        ...
        <div class="change_frame">
            <a href="../pages/chatRoom.jsp">SendMessage</a> <a href="../pages/chatRoomU.jsp">YourMessages</a> <a href="../pages/chatRoomTU.jsp">MessagesToYou</a> <a href="../pages/chatRoomUF.jsp">Friends</a>
            <br>
        </div>
    </div>