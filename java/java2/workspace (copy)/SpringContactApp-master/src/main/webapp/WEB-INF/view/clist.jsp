            ...
            <tr>
                <td height="350px" valign="top" width="100%">
                    ...
                    <table width="100%">
                        <tr>
                            <td align="right" >
                                <form action="<s:url value="/worker/contact_search"/>">
                    ...
                    <form action="<s:url value="/worker/bulk_cdelete"/>">           
                        ...
                        <table border="1" cellpadding="3"  width="100%">
                            ...
                            <c:forEach var="c" items="${contactList}" varStatus="st">
                                <tr>
                                    ...
                                    <td>${c.address}</td>
                                    <td>${c.remark}</td>    
                                    <s:url var="url_del" value="/worker/del_contact">
                                        <s:param name="cid" value="${c.contactId}"/>
                                    </s:url>   
                                    <s:url var="url_edit" value="/worker/edit_contact">
                                        <s:param name="cid" value="${c.contactId}"/>
                                    </s:url> 
