...
public class GetBestScore { // ++++++++++FINISHED
    private static Logger log = Logger.getLogger(GetBestScore.class.getName());// DONE +++++++++++++++++!
...
//"max22"
    ...
    public static ScoreElement getResults(int game_type, String period) throws ParseException { // amount = number of snippets
        ScoreElement scoreElement = null;
        try {
//            "http://maximcastlerock2.pythonanywhere.com/snippets/
            System.out.println(StateOfauthentication.getLogin());
            URL url = new URL("http://milkywayitis.pythonanywhere.com/api/top?game_type="+ game_type +"&username="+ StateOfauthentication.getLogin()+"&filter_by=" + period);
...
//                if(userObject.get("t"))
                ...
                scoreElement.setOwner("gerta2000");
