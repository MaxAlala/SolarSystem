...
<html>
    <head>
        ...
        <title>worker Registration - Contact Application </title>
                ...
                <td height="350px" valign="top">
                    ...
                    <f:form action="${url_reg}" modelAttribute="command">
                        <table border="1">
                            <tr>
                                <td>Name</td>
                                <td><f:input path="worker.name" /> </td>
                            </tr>
                            <tr>
                                <td>Phone</td>
                                <td><f:input path="worker.phone" /> </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><f:input path="worker.email" /> </td>
                            </tr>
                              <tr>
                                <td>Address</td>
                                <td><f:textarea path="worker.address" /> </td>
                            </tr>
                            <tr>
                                <td>Username</td>
                                <td><f:input id="id_username" path="worker.loginName" /> 
                            ...
                            <tr>
                                <td>Password</td>
                                <td><f:password path="worker.password" /> </td>
                            </tr>                           
                            <tr>                                
