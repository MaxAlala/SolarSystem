...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="welcome">
            ...
            %>
            <h5>Welcome, <%= author.getName()%>! Your credits: <%= author.getCredits()%></h5>

            <div class="user_image">
                <a href="#"><img src="<%=request.getContextPath()%>/ShowPersonImage" <%request.getSession().setAttribute("nameImage", author.getName()); System.out.println(request.getContextPath() + "/ShowPersonImage");%> height="100" width="100" alt="user"/></a>
            </div>
        ...
        <div class="change_frame">
            <%--<a href="<%=request.getContextPath()%>/AddFriend">--%>
            <%--<param name="friend_id" value="<%=author1.getId()%>"> AddFriend</a>--%>


                <form action="${pageContext.request.contextPath}/AddFriend" method="post">
                    <input type="submit" value="addToFriend">
                    <br><INPUT id="friend_id" TYPE="text" NAME="friend_id"value="<%= author1.getId() %>" style="display: none" readonly>
                    <br><INPUT id="friend_name" TYPE="text" NAME="friend_name"value="<%= author1.getName() %>" style="display: none" readonly>
                </form>
