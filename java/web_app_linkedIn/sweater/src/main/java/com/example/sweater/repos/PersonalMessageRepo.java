...
import com.example.sweater.domain.PersonalMessage;
import com.example.sweater.domain.User;
import org.springframework.data.jpa.repository.Query;
import org.springframework.data.repository.CrudRepository;


public interface PersonalMessageRepo extends CrudRepository<PersonalMessage, Long> {


//    Iterable<Group> findGroupsByAuthor(User user_id);

    @Override
    Iterable<PersonalMessage> findAll();


    Iterable<PersonalMessage> findAllByAuthor(User user);
    Iterable<PersonalMessage> findAllByReceiver(User user);
