...
@WithUserDetails(value = "dru") // authorise user for all test there
public class MainControllerTest {
    @Autowired
    private MainController controller;

    @Autowired
    private MockMvc mockMvc; // fake controller (all)

    @Test
    public void mainPageTest() throws Exception { // ftl doc isnt correct for xml specification
        this.mockMvc.perform(get("/main"))
                .andDo(print())
                .andExpect(authenticated())     //xpath is request language created for xml documents( html is some kind of xml)
